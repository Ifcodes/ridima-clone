...
const SupportIconMobile = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    fill="none"
  ...
  >
    <g opacity={0.3} fill="#7165E3">
      ...
      <path d="M11 22.75c-.41 0-.75-.34-.75-.75v-3.6c0-.41.34-.75.75-.75s.75.34.75.75V22c0 .41-.34.75-.75.75ZM15.44 8a.749.749 0 1 1-.003-1.498A.749.749 0 0 1 15.44 8ZM18.25 8a.749.749 0 1 1-.002-1.498A.749.749 0 0 1 18.25 8ZM12.62 8a.749.749 0 1 1-.002-1.498A.749.749 0 0 1 12.62 8Z" />
    </g>
  </svg>
);

export default SupportIconMobile;
