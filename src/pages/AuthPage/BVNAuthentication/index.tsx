...
const BVNAuthentication = () => {
  ...
  const formIsfilled = Object.values(bvnFormField).every(field => field !== '')
    ...
    >
      {currentStage === 1
        ...
        : <MiniFormCard
            ...
            btnSuffix={<ClipLoader color='white' loading={loading} css={override} size={35}/>}
          >
          <Input 
            id={generateId()}
            label='First name'
      ...
      >
        <BvnAuthModalContent>
          <div className='title-cont'>
            ...
            <ol>
              <li>
                Get access to a virtual bank account for transfers, funding and more. 
              </li>
              <li>
